                ...
                <form class="form-horizontal" action="/admin/admin-product/{{ $data->product_id }}" method="post" enctype="multipart/form-data">
                  ...
                  <div class="card-body">
                      ...
                      <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                              <input type="text" class="form-control" id="eproductname" name="productname" value="{{ $data->product_name }}" placeholder="Product Name...">
                          </div>
                      </div>
                      <div class="form-group row">
                    ...
                    {{-- <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                          <input type="text" class="form-control" id="etag" name="tag" value="{{ $data->product_name }}" placeholder="Tag...">
                      </div>
                    </div> --}}
